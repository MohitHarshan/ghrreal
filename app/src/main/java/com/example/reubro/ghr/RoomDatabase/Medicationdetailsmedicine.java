...
public class Medicationdetailsmedicine {
    ...
    public Medicationdetailsmedicine() {
    }

    public Medicationdetailsmedicine(int id, long patientno, int categoryno, int medicineno, String medname, String patient_id, String indication, String dose, String frequency, String startdate, String stopdate, String ongoing) {
        this.id = id;
